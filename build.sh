...
&& rm -rf main.zip \
&& mkdir -p $1 \
&& cp -r $temporary_dir/knight_visualizer-main $1/knight_visualizer \
&& rm -rf $temporary_dir \
&& echo -e "\033[0;32mSuccessfully downloaded to $1/knight_visualizer\033[0m" \
