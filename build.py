...
file = "knight_visualizer-"
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/knight_visualizer/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/knight_visualizer/archive/master.zip", tmp)
    file += "master"
